...
export const ortoImage = makePlaceholder(500, 400, '#b8b0d4', 'Ortomolecular')
...
export const clinicPhotoImage = makePlaceholder(600, 750, '#cca8bc', 'Consultório')
export const clinicPhotoImageTwo = makePlaceholder(600, 750, '#c8b0c4', 'Recepção')
